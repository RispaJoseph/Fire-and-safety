...
<p align= "right">
    <h3 style="position: relative;top:250px;left:20px;color:red">Change Password</h3>
...
if($tbl!=null)
{
	if($newpwd==$cpwd)
	{
$sql2="update login_ set password='$newpwd' where username='$username' and type='customer'";
