...
<?php
$sql="select * from myorder where buyer='$user'";
$tbl=getDatas($sql);
if($tbl==null){
									echo "<div style='position:relative;top:250px;left:620px;'><font color='black'>NO Orders...</font></div>";
...
<div class="col-lg-4 col-md-6 col-sm-6 product-men women_two">
	...
	echo "<img src='".$tbl[$i][8]."' style='position:relative;width:150px;height:200px;'><br>";
?>
</div>
<div class="item-info-product">
                                 <div class="info-product-price">
                                    <div class="grid_meta">
									   ...
									   <?php
	echo "&emsp;&emsp;<font color='red'>Product:</font>".$tbl[$i][2]."<br>
	
&emsp;&emsp;<font color='green'><b>Price:</b></font>".$tbl[$i][3]."<br>
&emsp;&emsp;<font color='green'><b>Payment Type:</b></font>".$tbl[$i][5]."<br>
&emsp;&emsp;<font color='green'><b>Order Date:</b></font>".$tbl[$i][4]."<br>
&emsp;&emsp;<font color='green'><b>del date:</b></font>".$tbl[$i][7]."<br>
&emsp;&emsp;<font color='green'><b>Track Status:</b></font>".$tbl[$i][6]."<br>";
