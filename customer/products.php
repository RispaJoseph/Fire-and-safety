...
if(isset($_GET['mode']))
{
 ...
 $m=$_GET['mode'];
 //echo $m;
 if($m=="fireextinguisher")
{
		$sql="select * from addproduct_reg where category='$m'";
...
<?php
	...
	&emsp;&emsp;&emsp;&emsp;<center><font color='green'>Brand:</font>".$tbl[$i][2]."</center>
	
&emsp;&emsp;&emsp;&emsp;<center><font color='green'>Price:</font>".$tbl[$i][6]."</center>";
	?>
