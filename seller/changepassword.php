...
<p align= "right">
    <h3 style="position: relative;top:200px;left:20px;color: #17c3a2;"><b>CHANGE PASSWORD</b> </h3>

<font style="font-size:30;color:black;"><b>

<form method="post" action="">
<table cellspacing="10" cellpadding="5" style="position:relative;top:270px;">
<tr>
...
if($tbl!=null)
{
	if($newpwd==$cpwd)
	{
$sql2="update login_reg
 set password='$newpwd' where username='$username' and type='seller'";
