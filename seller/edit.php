      ...
      <div id="err" style="color: red;height: 20px"></div>
           ...
           <tr><td></td></tr>
                 ...
                 <tr>
                    ...
                    <td>
                          <input type="text" name="email" value="<?php echo $tbl[0][3];?>"/>
                      </td>
                </tr>
                </tr> <tr><td></td></tr>
                 <tr>
                    <td>
                        <label> licensno:</label>
                    </td>
                    <td>
                          <input type="text" name="licensno" value="<?php echo $tbl[0][4];?>"/>
                      </td>
                </tr>
...
<?php
    ...
    $sql="update seller_reg set name='$a',address='$c',email='$d',licensno='$b' where email='$user'";
    setDatas($sql);
    msgbox("updated");
    }
