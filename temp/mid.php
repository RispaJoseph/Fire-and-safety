					...
					<div class="stats">
						<div class="row stats_inner">
							<div class="col-md-6 col-sm-6 col-xs-6 stat-grids">
								<img src="../temp/images/logo1.jpg" alt="logo1" class=" img-fluid">
							</div>
							<div class="col-md-6 col-sm-6 col-xs-6 stat-grids">
								<img src="../temp/images/logo2.jpg" alt="logo1" class=" img-fluid">
							</div>
						</div>
						<div class="row stats_inner top-st">
							<div class="col-md-6 col-sm-6 col-xs-6 stat-grids">
								<img src="../temp/images/logo3.jpg" alt="logo1" class=" img-fluid">
							</div>
							<div class="col-md-6 col-sm-6 col-xs-6 stat-grids">
								<img src="../temp/images/logo1.jpg" alt="logo1" class=" img-fluid">
							</div>
					...
					<div id="parentVerticalTab">
						...
						<div class="resp-tabs-container hor_1">
							<div class="text-info">
								...
								<img src="../temp/images/g1.jpg" alt=" " class="img-fluid" />

							</div>
							<div class="text-info">
							
								<img src="../temp/images/g2.jpg" alt=" " class="img-fluid" />

							</div>

							<div class="text-info">
								
								<img src="../temp/images/g6.jpg" alt=" " class="img-fluid" />
